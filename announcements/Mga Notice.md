...
inin na mga folders tas php files kay placeholder pala, puydi pa ini mag bago depende hit at pag develop, gin sugad ko an structure para ma hit nat an criteria na "clean code".
...
(or gusto niyo mag switch to vice-versa yakan la)
